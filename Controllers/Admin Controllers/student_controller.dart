...
// this is the student controller //// it will controll all the functionaliies for a student like adding a student editing and alll
...
// this is the function to add a new student we pass these data's to this function from the student adding page
  Future<void> addStudent({ 
    ...
    try {
      ...
      final UserCredential userCredential = await _auth
          .createUserWithEmailAndPassword(email: email, password: password);  // then this function create a account with just email and password in firebase ...in authentication page we can see that 

      String uid = userCredential.user!.uid;

      // Add student data to Firestore
      await _firestore.collection('students').doc(uid).set({  /// and the other data's like all the route details and other will go to a collection 'students' /// in firebase we call as collection like tables in sql
        'studentId': uid,
        'name': name,
        'email': email,
  ...
  } // i hope u understand what am trying to tell yes bro.. okayy
  ...
  } // some functions are a bit confusing . I'll text you if i got any doubt while checking the functions. could you please explain me about the linking of frontend to backend. we'll close the sessi
  // for example i will show u how the admin can see the students okey okay
